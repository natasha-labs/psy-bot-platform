...
from personality_code.upsell_screen import get_full_profile_keyboard
...
async def send_after_test_step(update, context, test_def, result_text, profile_payload):
    chat_id = update.effective_chat.id
